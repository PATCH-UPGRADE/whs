...
import { PersistentSynchronizable, relationship } from "@hadron/entanglement/persistence";
...
relationship(VmImage as any, Device as any, {
  keys: ["vm_image_id"],
...
relationship(ContainerImage as any, Device as any, {
